...
// Automatic generate username for user
...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    // TODO: In each call, print the remaining time to the UI
    labelTimer.textContent = `${min}:${sec}`;

    // TODO: When 0 seconds, stop timer and log out user
    if (time === 0) {
      clearInterval(timer);
  ...
  // TODO: Call the timer every second
  tick();
...
console.log(67334877348378734737374843787447n);
console.log(BigInt(62372));

// Operation
console.log(10000n + 10000n);
console.log(6723236364238282833222322223333n * 443555n);
// console.log(Math.sqrt(16))

const huge = 23389938489434893483484n;
const num = 23;
...
console.log(new Date('Sat Mar 04 2023 01:33:51'));
